    ...
    return (
      <Card>
        <p className="text-sm text-amber-800">
          UPI payments are not configured on this server yet. Ask your platform admin to set{' '}
          <span className="font-mono">PLATFORM_UPI_VPA</span> and upload a QR code.
        </p>
      </Card>
    );
  }
            ...
            <div className="mt-4 space-y-2 text-sm">
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="font-medium text-slate-900">
                  {paymentConfig.upi_payee_name || 'AutoWave'}
                </span>
              </div>
              <div className="flex items-center justify-between gap-2">
          ...
          <div className="space-y-4">
            {canSubmit ? (
              <>
                ...
                <Button className="w-full" loading={submitting} onClick={submitPayment}>
