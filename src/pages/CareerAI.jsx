      ...
      <div className="hero-gradient p-5 sm:p-7">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button variant="secondary" onClick={runDigest} className="!border-white/20 !bg-white/10 !text-white hover:!bg-white/20">
              <Send size={16} className="mr-1 inline" />
              Run digest
            </Button>
            <Button variant="secondary" onClick={seedJobs} className="!border-white/20 !bg-white/10 !text-white hover:!bg-white/20">
              Sample jobs
            </Button>
          </div>
        </div>
